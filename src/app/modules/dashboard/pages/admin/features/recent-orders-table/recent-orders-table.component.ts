...
import { CardComponent, HeaderDashboardComponent, IconComponent, ProgressBarComponent } from 'src/ui';
import { RecentOrderDto } from './dtos';

@Component({
  selector: 'app-recent-orders-table',
  imports: [CardComponent, HeaderDashboardComponent, IconComponent, ProgressBarComponent, CurrencyPipe, DatePipe],
