...
export class CreatePermissionService {
  ...
  readonly #submit$ = new Subject<CreatePermissionDto>();
  ...
  constructor() {
    this.#submit$
      .pipe(
        ...
        switchMap((input) =>
          this.#httpClient.post(`${ApiPathEnum.AUTH}/roles-and-permissions/permissions`, input).pipe(
            tap(() => {
  ...
  create(input: CreatePermissionDto) {
